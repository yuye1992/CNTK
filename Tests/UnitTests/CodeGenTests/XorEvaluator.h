...
namespace CNTK
{
    ...
    public:
        ...
        Halide::Pipeline create_eval_graph(const Halide::ImageParam& Input3)
        {
            ...
            auto b_Parameter25 = Halide::Buffer<float>(m_Parameter25.data(), 1, 2, "Parameter25");
            ...
            Halide::Func Times103("Times103"); Times103 = VectorByMatrixTimes(Input3, Parameter5, 2, 2);
