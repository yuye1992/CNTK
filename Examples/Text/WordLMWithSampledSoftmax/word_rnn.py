...
alpha = 0.75
learning_rate = 0.002
momentum_as_time_constant = 0.9999
...
def train_lm():
    ...
    momentum_schedule = C.momentum_schedule_from_time_constant(momentum_as_time_constant, sequences_per_batch * sequence_length )
