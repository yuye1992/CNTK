...
def create_trainer(network, epoch_size, num_quantization_bits, progress_printer):
    ...
    # Create learner
    local_learner = C.learner.momentum_sgd(network['output'].parameters, lr_schedule, mm_schedule, unit_gain=False, l2_regularization_weight=l2_reg_weight, use_mean_gradient=True)
